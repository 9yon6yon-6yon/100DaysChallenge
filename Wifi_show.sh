...
ifconfig
read -p $' \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;93m Select an interface: \e[0m\e[1;96m\en' interface
...
while true; do
printf "\nPress \e[1;93m q\e[0m \e[9;93m to stop monitor mode\e[0m\n"
read -r input
if [ "$input" = "q" ];then
stop
fi 
